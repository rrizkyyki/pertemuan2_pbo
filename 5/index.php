...
$allPegawai = $pegawai->query($connection->conn,"SELECT *, (YEAR(CURDATE())-YEAR(tgl_lahir)) AS umur FROM pegawai WHERE (YEAR(CURDATE())-YEAR(tgl_lahir)) BETWEEN 20 AND 30");
