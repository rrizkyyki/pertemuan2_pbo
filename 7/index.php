...
$allPegawai = $pegawai->query($connection->conn,"SELECT *, (YEAR(CURDATE())-YEAR(mulai_kerja)) AS masa FROM pegawai WHERE (YEAR(CURDATE())-YEAR(mulai_kerja)) BETWEEN 1 AND 5");
